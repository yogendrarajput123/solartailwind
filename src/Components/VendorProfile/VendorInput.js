          ...
          <div className="form bg-white p-6 flex s:flex-col md:flex-row md:ml-0 md:mr-0 m:ml-8 m:mr-8">
            ...
            <div className="second-column md:mt-16 md:ml-7 sm:ml-8 xl2:ml-14">
              ...
              <div className="mt-20">
                ...
                <p className="mt-2">HPS Hydro Consultants Pvt. Ltd.</p>
              </div>
              <div className="mt-6">
                <p className="text-xl font-semibold">Contractor ID</p>
                <p className="mt-2">RFTPCTR146</p>
              </div>
              <div className="mt-6">
            ...
            <div className="third-column md:mt-[166px] s:mt-10 md:ml-14 lg:ml-16 xl2:ml-24">
              <div>
                ...
                <div className="flex mt-2">
                  <div className="">
                    ...
                    <p className="mt-2">9:15 AM</p>
                  </div>
                  <div>
                    <p className="text-lg font-medium s:ml-12 md:ml-6">
                      Closing
                    </p>
                    <p className="mt-2 ml-7">9:15 AM</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6">
                ...
                <p className="mt-2">yogendra.coderform@gmail.com</p>
              </div>
              ...
              <div className="s:mt-7 md:mt-12 md:ml-10 s:ml-10 xl2:ml-20">
                <button
