      ...
      >
        <ul className="flex flex-col gap-y-5 pt-28 pl-6 ">
          ...
          <div className="space-y-3 lg:hidden">
            <li className="flex items-center gap-x-2 text-sm s:-ml-2 hover:text-white rounded hover:bg-[#235688] hover:p-1 ">
          ...
          <li className="flex items-center gap-x-2 break-words  xl2:mt-[590px] lg:mt-[640px] lg:mb hover:bg-[#235688] rounded m:hover:p-2 m:hover:w-36 s:hover:w-32 s:hover:p-1">
            ...
            <div className="right-content">
              <div className="Review-Rating border-b-4 border-solid border-blue-100  md:p-6 s:p-2 ">
                ...
                <div className="flex xl2:space-x-8 xl2:ml-96 md:ml-72 mt-3 m:ml-4 sm:ml-8 ">
                  <p className="md:text-2xl text-[#233965] font-semibold hover:bg-[#235688] rounded hover:text-white p-2">
                    Reviews
                  </p>
                  <p className="md:text-2xl text-[#233965] font-semibold hover:bg-[#235688] rounded hover:text-white p-2">
                    Ratings
              ...
              <div className="Rating-Section1 border-b-4 border-solid border-blue-100 md:p-6 s:p-4">
                <div className="flex s:flex-col md:flex-row  m:ml-4 md:ml-0 sm:ml-8">
                  <div className="md:w-10 md:h-10 s:w-16 s:h-16 rounded-full overflow-hidden s:ml-20 md:ml-0">
                    <img
                  ...
                  <div className="md:ml-4 space-y-2">
                    <p className="flex md:flex-row s:flex-col ">
                      ...
                      <p className="text-[#8F99B1] md:hidden">10 days ago</p>
                      <div className="flex items-center xl2:ml-[450px] md:ml-[270px] lg:ml-[250px]">
                        <svg
                        ...
                        <svg
                          className="md:w-6 md:h-6 s:w-7 s:h-7  text-gray-300"
                          aria-hidden="true"
                          xmlns="http://www.w3.org/2000/svg"
                          fill="currentColor"
                          viewBox="0 0 22 20"
                    ...
                    <p className="text-[#8F99B1] hidden md:block">
                      10 days ago
                    </p>
                  </div>
                </div>
              ...
              <div className="Rating-Section2 border-b-4 border-solid border-blue-100 md:p-6 s:p-4">
                <div className="flex s:flex-col md:flex-row  m:ml-4 md:ml-0 sm:ml-8">
                  <div className="md:w-10 md:h-10 s:w-16 s:h-16 rounded-full overflow-hidden s:ml-20 md:ml-0">
                    <img
                      className="object-cover w-full h-full"
              ...
              <div className="Rating-Section3 border-b-4 border-solid border-blue-100 md:p-6 s:p-4">
                <div className="flex s:flex-col md:flex-row  m:ml-4 md:ml-0 sm:ml-8">
                  <div className="md:w-10 md:h-10 s:w-16 s:h-16 rounded-full overflow-hidden s:ml-20 md:ml-0">
                    <img
                      className="object-cover w-full h-full"
