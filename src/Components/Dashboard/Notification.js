  ...
  return (
    <div className="main flex">
      ...
      <div className="content h-screen ">
        <div className="navbar md:w-[100%] s:h-[] md:h-[15%] flex justify-end items items-center gap-x-5 m-2">
          <img
                ...
                <div className=" overflow-x-auto xl2:h-[700px] md:h-[660px] s:h-[620px]">
                  <div className="Images-active md:space-y-3 s:space-y-5 xl2:space-y-6 s:mb-14 md:mb-auto">
                    <div className="flex md:mt-5 s:mt-8 bg-blue-50 w-[92%] ml-2 md:p-2 s:p-2 xl2:p-4">
                      <div className="md:w-13 md:h-7 lg:w-13 lg:h-7 xl2:w-24 xl2:h-12 xl3:w-30 xl3:h-30 s:w-16 s:h-8 m:w-14 m:h-8 sm:w-14 sm:h-10 rounded-full  overflow-hidden ml-2">
                        <img
                          className="object-cover w-full h-full "
                          src={person}
                          alt=""
