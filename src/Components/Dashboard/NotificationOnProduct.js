...
function NotificationOnProduct() {
  ...
  return (
    <div className="main flex">
      ...
      <div
        ...
        } lg:block s:w-[50%] s:h-[90%] md:w-[25%] md:h-[92%]  z-40 s:bg-blue-100 lg:bg-white h-screen s:break-words lg:w-[20%]`}
      >
        <ul className="flex flex-col gap-y-5 pt-28 pl-6 xl2:pl-4 -ml-3">
          ...
          <button>
            <p className="font-bold md:text-xl hover:bg-[#235688] rounded hover:p-1 hover:text-white -ml-6">
              Log out
            </p>
          </button>
        </ul>
      ...
      <div className="content h-screen lg:w-[85%] xl2:w-[90%]">
        <div className="navbar md:w-[100%] h-[15%] s:h-[15%] md:h-[15%] flex md:justify-end items items-center md:gap-x-5 s:gap-x-1 sm:gap-x-2 s:ml-[90px] m:ml-36 sm:ml-44 md:ml-0">
          <img
            ...
            <div className="three-container p-5">
              <div className="Your-profile-like bg-white md:w-[100%] s:w-auto s:mt-auto md:mt-auto">
                ...
                <div className="flex s:flex-col s:p-4 md:flex-row md:ml-0 md:-mt-7">
                  <div
                    className="bg-blue-100 inline-block md:mt-7 md:ml-9 lg:ml-4 xl2:ml-10 s:p-6 md:p-5 mb-7 xl2:mb-3 lg:p-6 xl2:p-12
                  ...
                  <div
                    className="bg-pink-100 inline-block md:mt-7 md:ml-9 lg:ml-4 xl2:ml-10 s:p-6 md:p-5 mb-7 xl2:mb-3 lg:p-6 xl2:p-12
                                          s:h-[170px] md:w-[30%] xl2: md:h-auto s:ml-5 s:mr-5 m:ml-5 m:mr-5 sm:ml-10 sm:mr-10 s:mt-7"
                  >
                    <img
                      src={amonth}
              ...
              <div className="Notification-Likes flex s:flex-col md:flex-row pt-6">
                <div className="notification bg-white md:w-[100%] s:w-[100%] md:h-[400px] s:mt-5 md:mt-0  overflow-x-auto">
                  <div className="flex md:p-3 s:p-4">
                    <p className="font-semibold md:text-lg xl2:text-2xl s:text-xl">
                      Notification
                    </p>
                    <button
                      className="border-2 rounded border-[#8F99B1] text-[#8F99B1] md:px-2 md:ml-[400px] lg:ml-[370px]
                  ...
                  <div className="grid grid-cols-2 md:mt-8 s:mt-8 s:w-[90%] s:ml-3.5 bg-gray-100">
                    ...
                    <div className=" s:-ml-16 m:-ml-20 xl2:-ml-80 md:-ml-64 lg:-ml-60 sm:-ml-24 md:space-y-2 s:space-y-3 -mt-1 s:p-3">
            ...
            <div className="Vendors bg-white  md:w-[100%] s:w-[100%] md:-ml-2 xl2:ml-6 s:m-5 md:mt-7 s:mt-8">
              <div className="content">
                <div className="flex p-2 xl2:p-3">
                  ...
                  <button
                    className="border-2 rounded border-[#8F99B1] text-[#8F99B1] md:px-2 md:ml-5 lg:ml-14 xl2:ml-36
                               s:px-1 s:py-0 md:py-0 s:text-1xl md:text-base xl2:text-lg s:mt-2 md:mt-auto s:ml-16 m:ml-32 sm:ml-44"
                  >
                    See vendor
                  </button>
                </div>
...
export default NotificationOnProduct;
