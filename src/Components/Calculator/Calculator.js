          ...
          <div className="Content bg-blue-50 w-full h-[100%] rounded-sm md:p-8 s:p-2">
              ...
              <div className="flex s:flex-col md:flex-row md:justify-center md:items-center ml-0">
                <div className="md:w-[50%] s:w-[100%]">
                  <input
                    type="text"
                    placeholder="12m"
                    className="rounded-sm mt-3 p-2 border border-black s:w-[100%] md:w-[50%]"
                  />
                ...
                <div className="flex s:flex-col md:flex-row md:items-center md:space-x-2 md:w-[50%] s:w-[100%] md:-mt-6 lg:mt-0">
                  ...
                  <p className="bg-white s:w-[100%] md:w-[50%] p-2 h-10 border rounded-sm mt-2 border-black">
                    12%
                  </p>
            ...
            <div className="Third-Section">
              ...
              <input
                type="text"
                placeholder="8"
                className="rounded-md mt-3 p-2 border border-gray-200 md:w-[20%] s:w-[100%]"
              />
